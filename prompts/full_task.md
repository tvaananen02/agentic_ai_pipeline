...
8. If, and only if, the application is a persistent web server rather than a script or library, it must listen on port 8000, and you must start it, verify with a real request that it responds, and stop it before finishing.
